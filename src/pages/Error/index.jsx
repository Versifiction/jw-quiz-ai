...
function Error() {
          ...
          for (let y = 0; y < canvasHeight; y++) {
            ...
            for (let x = 0; x < canvasWidth; x++) {
              ...
              if (sourceX >= 0 && sourceX < canvasWidth) {
                ...
                destinationPixels[destIndex + 1] =
                  sourcePixels[sourceIndex + 1];
                destinationPixels[destIndex + 2] =
                  sourcePixels[sourceIndex + 2];
                destinationPixels[destIndex + 3] =
  ...
  return (
    <div className="w-full bg-gradient-to-r from-[#4A6DA7] to-[#a0b4d5] relative">
      <Nav />
      <div className="container mx-auto max-w-[768px]">
        <div className="w-full flex flex-col items-center justify-center text-center font-mono select-none py-36">
          <HoverGlitch
            text="404"
            fontFamily="'Major Mono Display', monospace"
            ...
            wordSpacing="-0.1em"
          />
          <Link to="/" className="mt-8 text-white font-sans">
