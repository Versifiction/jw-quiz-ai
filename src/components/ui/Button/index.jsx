...
const Button = React.forwardRef(
  (
    ...
    const variantClasses = {
      default:
        "bg-slate-900 text-slate-50 text-2xl hover:bg-slate-900/90 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50/90",
      destructive:
        "bg-red-500 text-white text-2xl hover:bg-red-600 dark:bg-red-600 dark:text-white dark:hover:bg-red-700",
      outline:
        "border border-[#4A6DA7] text-2xl bg-white hover:opacity-50 text-[#4A6DA7] dark:border-slate-800 dark:hover:bg-slate-800 dark:text-slate-50",
      primary:
        "bg-[#4A6DA7] text-white text-2xl hover:opacity-50 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-700",
      secondary:
        "bg-white text-[#4A6DA7] text-2xl hover:opacity-50 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-700",
      ghost:
        "hover:bg-slate-100 text-2xl text-slate-900 dark:hover:bg-slate-800 dark:text-slate-50",
      link: "text-slate-900 text-2xl underline-offset-4 hover:underline dark:text-slate-50",
    };
    const sizeClasses = {
