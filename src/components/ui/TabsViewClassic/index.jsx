...
import characters from "../../../utils/shapes/characters";
import books from "../../../utils/shapes/books";
  ...
  const tabs = [
    {
      ...
      content: "Quiz triés par difficulté",
    },
    {
      id: 2,
      name: "Personnages",
        ...
        <div className="grid-cols-3 grid gap-2">
          {characters?.map((character) => (
            <div key={character.slug}>
              <Link
                to={`/quiz/personnages/${character.slug}`}
                state={{ name: character.name }}
              >
                <ThreeDCard>
                  <div className="p-6">
                    <h3 className="text-xl font-bold text-white overflow-hidden whitespace-nowrap text-ellipsis">
                      {character.name}
                    </h3>
    ...
    <div className="w-full max-w-2xl mx-auto py-8">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className={`relative overflow-hidden rounded-xl p-6 bg-white dark:bg-gray-800 shadow-lg border-t-4 border-gradient-to-r ${
